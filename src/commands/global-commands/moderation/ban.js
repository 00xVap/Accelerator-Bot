...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) =>
      option.setName("reason").setDescription("Reason for banning this user.")
    ),
  ...
  async execute(interaction, client) {
    ...
    const perms = interaction.channel
      ...
      .has(PermissionFlagsBits.BanMembers, false);

    if (!perms) {
      embed.setDescription(`
                <:Error:977069715149160448> I don't have enough permissions to do this command!
                <:space:1005359382776778802>**»** *Missing Permissions: \`BAN_MEMBERS\`*
            `);
    ...
    if (!member.bannable) {
      embed.setDescription(
        `<:Error:977069715149160448> Couldn't ban this user!`
      );
    ...
    embed.setDescription(`
            **Are you sure you want to ban this user?**
            ...
            <:space:1005359382776778802>**»** *Reason: ${
